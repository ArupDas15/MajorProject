...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container">
                <img class="img-fluid mb-5 d-block mx-auto" src="img/payment.png" alt="">
                <h1 class="text-uppercase mb-0">Transaction Details</h1>
                <hr class="star-light">
                <h2 class="font-weight-light mb-0"> View and Verify Transactions</h2>
            </div>
        </header>
