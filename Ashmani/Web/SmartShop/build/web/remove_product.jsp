...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container">
                <img class="img-fluid mb-5 d-block mx-auto" src="img/remove.png" alt="remove product">
                <h1 class="text-uppercase mb-0">Product</h1>
                <hr class="star-light">
                <h2 class="font-weight-light mb-0">Remove</h2>
            </div>
        </header>
        ...
        <section id="update_product">
            <div class="container">
                <h2 class="text-center text-uppercase text-secondary mb-0">Remove Product Details</h2>
                    ...
                    <div class="col-lg-8 mx-auto">
                        <form action="./RemoveProduct" method="post">
                            <table class="col-lg-12 text-uppercase text-center table-bordered">
                                ...
                                <td><input type="submit" class="btn btn-dark btn-block" value="Remove"/></td>
                                </tr>
                                <%
                                    }
                                %>
